    ...
    <VanPopup v-model:show="show" style="background: transparent;" position="bottom" overlay-class="cusMask" teleport="#app">
        <div class="popup">
            <div class="content">
                ...
                <div class="size26 opc5 mt40 mb16">{{ $t('支付方式') }} <span class="opc5">{{ $t('（可多选）') }}</span></div>
                ...
                <div class="mainBtn mt100 flex jc ac size28 main bold6 btn" @click="submit">{{ $t('确认出售') }}</div>
